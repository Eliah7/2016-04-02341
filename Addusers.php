                        ...
                        <section class="vbox">
                            <section class="scrollable padder">
                                <section class="row m-b-md">
                                    <div class="col-sm-6"><h3 class="m-b-xs text-black">Users</h3>
                                ...
                                <section class="panel panel-default">
                                    <header class="panel-heading"> User Table <i class="fa fa-info-sign text-muted"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped m-b-none" data-ride="datatables">
                                            ...
                                            <tr>
                                                ...
                                                <th width="20%">User Key</th>
                                                <th width="15%">Age</th>
                                                <th width="15%">Hospital</th>
                                                <th width="15%">User Ocupation</th>
